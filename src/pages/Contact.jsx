...
function Contact() {
  ...
  return (
    <motion.div
      ...
      className="w-[100vw] px-6 my-5 md:my-30 md:py-8 md:px-35 select-none"
    >
        {/* File Header */}
        <div className="w-full border-b border-[#474747] flex items-center mb-10 hover:cursor-pointer">
          <div className="px-4 py-2 bg-[rgb(64,64,64)] border border-[#373737] flex items-center space-x-4 group">
            <span className="text-[#d8d8d8] text-sm font-extralight">contact.java</span>
        ...
        <div className="flex flex-col md:ml-25">
          ...
          <div className="flex flex-col md:flex-row gap-5 md:gap-10">
            ...
            <div className="w-full md:w-[65%] bg-[rgb(38,38,38)] p-6 md:p-8 rounded-lg shadow-lg border border-[#474747]">
              <form className="space-y-3 md:space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="flex justify-end">
                  <button type="submit" className="bg-[rgb(9,105,230)] text-[#dddddd] py-2 px-6 rounded-lg hover:bg-[rgb(5,91,205)] transition hover: cursor-pointer">
                    Send Message →
                  </button>
                </div>
              </form>
            ...
            <div className="w-[full] grid grid-cols-2 gap-3 md:w-[20%] md:grid-cols-1">
              {[
                { icon: <Mail size={18} className="text-blue-400" />, title: "Email", value: "prateekbisht04@gmail", link: "mailto:prateekbisht04@gmail.com" },
